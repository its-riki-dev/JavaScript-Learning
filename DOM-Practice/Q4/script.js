// Built an interactive image gallery with a search functionality that filters and displays matching results dynamically.
...
function handleSearchFunctionality(){
    ...
    input.addEventListener("blur", function(){
        setTimeout(() => { // Delayed to prevent disappearing before click
    ...
    input.addEventListener("input", function(){
        ...
        if (filteredArray.length > 0) {
            ...
            clutter = `<div class="res flex px-8 py-3 text-gray-500">
                <i class="ri-search-line font-semibold mr-5"></i>
                <h3 class="font-semibold">Search not found</h3>
            </div>`;
        }
